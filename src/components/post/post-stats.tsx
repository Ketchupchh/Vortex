...
import { manageRepost, manageLike } from '../lib/firebase/utils';
import { ViewPostStats } from './view/view-post-stats';
    ...
    <>
      ...
      >
        ...
        <PostOption
          ...
          move={postMove}
          stats={currentPosts}
          iconName='ArrowPathRoundedSquare'
          viewPost={viewPost}
