...
import { StatsEmpty } from '../post/stats-empty';
import { Loading } from '@/components/ui/loading';
import { variants } from '@/components/user/user-header';
import { UserCard } from './user-card';
import type { User } from '../lib/types/user';
import type { StatsType } from '../post/view/view-post-stats';
import type { StatsEmptyProps } from '../post/stats-empty';
...
const allNoStatsData: Readonly<NoStatsData> = {
  reposts: {
    ...
    imageData: { src: '/assets/no-reposts.png', alt: 'No reposts' },
    description:
...
export function UserCards({
  ...
  const modal = ['reposts', 'likes'].includes(type);
