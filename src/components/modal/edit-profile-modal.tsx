      ...
      >
        <div className='group relative mt-[52px] h-36 xs:h-44 sm:h-48'>
          ...
          <div className='absolute left-1/2 top-1/2 flex -translate-y-1/2 -translate-x-1/2 gap-4'>
            ...
            {coverPhotoURL && (
              ...
              >
                <CustomIcon className='hover-animation h-6 w-6 text-dark-primary group-hover:text-white' iconName='XMark' />
        ...
        <div className='relative flex flex-col gap-6 px-4 py-3'>
          <div className='mb-8 xs:mb-12 sm:mb-14'>
            ...
            <div
              className='group absolute aspect-square w-24 -translate-y-1/2
                         overflow-hidden rounded-full xs:w-32 sm:w-36 ring-4 ring-black'
            >
              <NextImage
                useSkeleton
                className='h-full w-full bg-main-background inner:rounded-full'
          ...
          >
            ...
            <i>
              <ChevronRightIcon className='h-6 w-6 text-light-secondary dark:text-dark-secondary' />
            </i>
          </Button>
        </div>
      </section>
